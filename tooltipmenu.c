 ...
 * Object Stuff
 *****************************************************************************/
static void tooltip_menu_get_property(GObject *obj, guint param_id,
...
static void tooltip_menu_finalize(GObject *obj) {
#if 0
...
static void tooltip_menu_class_init(TooltipMenuClass *klass) {
  ...
  pspec = g_param_spec_object("box", "The box", "The box", GTK_TYPE_BOX,
                              G_PARAM_READABLE);
...
GtkWidget *tooltip_menu_new() { return g_object_new(TYPE_TOOLTIP_MENU, NULL); }
...
static void tooltip_menu_add(TooltipMenu *tooltip_menu, GtkWidget *widget,
